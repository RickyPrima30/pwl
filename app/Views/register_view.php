            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                <div class="d-flex justify-content-center py-4">
                    <a href="index.html" class="logo d-flex align-items-center w-auto">
                        ...
                        <span class="bi bi-bag-fill"> HEHEH</span>
                    </a>
                </div><!-- End Logo -->
                <div class="card mb-3">
                    <div class="card-body">
                        ...
                        <form class="row g-3 needs-validation" novalidate method="post" action="<?= base_url('register') ?>">
                            ...
                            <input type='hidden' name='role' class="form-hiddden" id="you" value='user'>
                            <div class="col-12">
                ...
                <div class="credits">
                    ...
                    Designed by <a href="https://bootstrapmade.com/">HEHEH</a>
                </div>
